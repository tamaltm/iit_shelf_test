...
class ReturnCompletedPage extends StatelessWidget {
  final String title;
  final String image;
  final String role;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Returned button (green, disabled state)
              SizedBox(
                width: double.infinity,
                child: ElevatedButton(
                  onPressed: null, // Disabled since book is already returned
